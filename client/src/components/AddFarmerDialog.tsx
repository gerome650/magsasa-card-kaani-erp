...
import { addFarmer, type Farmer } from "@/data/farmersData";
...
export default function AddFarmerDialog({
  ...
  const handleSubmit = () => {
    ...
    // Create new farmer
    const newFarmer: Omit<Farmer, "id"> = {
      name: formData.name,
    ...
    toast.success(`Farmer ${formData.name} added successfully!`);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Register a new farmer in the MAGSASA-CARD system
          </DialogDescription>
        </DialogHeader>
